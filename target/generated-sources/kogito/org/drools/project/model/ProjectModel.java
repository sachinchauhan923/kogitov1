...
public class ProjectModel implements org.drools.modelcompiler.CanonicalKieModuleModel {
    ...
    public java.util.List<Model> getModels() {
        return java.util.Arrays.asList(new org.acme.travels.Rules122e79b835fa4bc39b436bedf9d58da6());
    }

    public java.util.List<Model> getModelsForKieBase(String kieBaseName) {
        switch (kieBaseName) {
            case "defaultKieBase": return java.util.Arrays.asList( new org.acme.travels.Rules122e79b835fa4bc39b436bedf9d58da6() );
        }
